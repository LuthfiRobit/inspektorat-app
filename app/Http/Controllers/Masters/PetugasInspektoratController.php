...
class PetugasInspektoratController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('aksi', function ($item) {
                ...
                $hasDelete = $user->hasPermissionTo('master.petugas.inspektorat.delete');
                if ($hasDelete) {
    ...
    /**
     * Remove the specified Petugas Inspektorat from storage (Soft Delete).
     */
    public function destroy($id)
    {
        $petugas = Petugas::whereNull('kecamatan_id')->whereNull('desa_id')->find($id);

        if (!$petugas) {
            $this->logActivityService->log('Petugas Inspektorat not found for delete', 'ID: ' . $id);
            return $this->responseService->error('Data not found', ResponseService::STATUS_NOT_FOUND);
        }
        ...
        try {
            ...
            $this->logActivityService->log('Deleted Petugas Inspektorat (Soft Delete)', 'ID: ' . $id);
