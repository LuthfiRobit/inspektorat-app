...
@section('title', 'Buat Laporan Kegiatan | Sistem Pelaporan')
    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            <div class="form-head mb-4 d-flex align-items-center gap-2">
                ...
                <h4 class="text-dark fw-semibold mb-0">Buat Laporan Kegiatan</h4>
            </div>
                    ...
                    <div class="card">
                        <div class="card-header border-0 pb-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h4 class="fs-20 text-black mb-1">Form Laporan Kegiatan</h4>
                                    <span class="fs-12 text-muted">Isi form berikut untuk membuat laporan kegiatan</span>
                                </div>
                                <div class="d-flex gap-2">
                                    <button type="button" class="btn btn-outline-primary" id="saveDraftBtn">
                                        <i class="las la-save me-1"></i>Simpan Draft
                                    </button>
                                    <button type="button" class="btn btn-success" id="submitLaporanBtn">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <small class="text-muted ms-3" id="progressText">0%</small>
                            </div>
                            ...
                            <!-- Form Laporan -->
                            <form id="laporanForm">
                                <input type="hidden" id="laporan_id" name="laporan_id" value="{{ $id ?? '' }}">
                            ...
                            <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                                ...
                                <div class="d-flex gap-2">
                                    <button type="button" class="btn btn-outline-primary" id="saveDraftBottom">
                                        <i class="las la-save me-1"></i>Simpan Draft
                                    </button>
...
@section('this-page-scripts')
    @include('administration.monev.buatLaporan.scripts.create-handler')
@endsection
