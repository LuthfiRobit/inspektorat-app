                        ...
                        <div class="card-header border-0 pb-0">
                            <div class="d-flex align-items-center justify-content-between w-100 flex-wrap">
                                ...
                                <div class="mb-2 mb-md-0">
                                    <h4 class="fs-20 text-black mb-1">Form Edit Laporan Kegiatan</h4>
                                    <span class="fs-12 text-muted">Edit laporan kegiatan yang sudah ada</span>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-primary">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <small>Disunting Pada Tgl.:</small>
                                        <div class="fw-bold fs-6" id="info_updated_at">-</div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <small>Approval Oleh:</small>
                                        <div class="fw-bold fs-6" id="info_approved_by">-</div>
                                    </div>
                                    <div class="col-md-8">
                                        <small>Catatan Approval:</small>
                                        <div class="fw-normal fs-6" id="info_approval_note" style="white-space: pre-wrap;">-
                                        </div>
                                    </div>
                                </div>
                            </div>
