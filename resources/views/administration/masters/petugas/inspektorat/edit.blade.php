    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            ...
            <div class="form-head mb-3 d-flex align-items-center gap-2">
                ...
                <h4 class="text-dark fw-semibold mb-0">Petugas Inspektorat</h4>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header-compact border-0">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    <h5 class="mb-1 fw-bold" style="font-size: 1rem;">Ubah Data Petugas</h5>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm bg-light" id="edit_nip"
                                                name="nip" placeholder="Masukkan NIP" aria-label="Nomor Induk Pegawai"
                                                maxlength="20" autocomplete="off" readonly />
                                            <small class="form-text-helper">
                                                <i class="las la-lock"></i> NIP digunakan sebagai username petugas dan tidak
                                                dapat diubah.
                                            </small>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="edit_nama_lengkap"
                                                ...
                                                aria-label="Nama Lengkap" maxlength="100" autocomplete="off" required />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control form-control-sm" id="edit_alamat" name="alamat"
                                                rows="2" placeholder="Masukkan alamat lengkap" aria-label="Alamat"
                                                required></textarea>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="edit_no_telp"
                                                    name="no_telp" placeholder="Masukkan nomor telepon"
                                                    aria-label="Nomor Telepon" maxlength="20" autocomplete="off" required />
                                            </div>
                                        </div>
