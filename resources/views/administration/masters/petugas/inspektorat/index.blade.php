...
@section('title', 'Petugas Inspektorat | Sistem Pelaporan')
@section('meta-description', 'Halaman untuk mengelola data petugas Inspektorat dalam sistem pelaporan.')
...
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block border-0 pb-0 flex-wrap align-items-center">
                        <div class="me-auto mb-sm-0 mb-3">
                            ...
                            <span class="fs-12 text-muted">Kelola data petugas Inspektorat dengan mudah.</span>
                        </div>
    ...
    @include('administration.masters.petugas.inspektorat.components.detail')
@endsection
...
@section('this-page-scripts')
    ...
    @include('administration.masters.petugas.inspektorat.scripts.datatable-init')
    @include('administration.masters.petugas.inspektorat.scripts.action-handler')
@endsection
