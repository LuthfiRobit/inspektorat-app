...
@section('title', 'Tambah Petugas Inspektorat | Sistem Pelaporan')
@section('meta-description', 'Form untuk menambah data petugas Inspektorat baru.')
                        ...
                        <div class="card-body-compact">
                            ...
                            <form id="createForm" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            ...
                                            <select id="jabatan" name="jabatan"
                                                ...
                                                data-live-search="false" aria-label="Pilih Jabatan" required>
                                ...
                                <div class="d-flex justify-content-between gap-2 mt-3 pt-3 border-top">
                                    <button type="button" class="btn btn-secondary btn-action" onclick="history.back()">
...
@section('this-page-scripts')
    @include('administration.masters.petugas.inspektorat.scripts.create-handler')
@endsection