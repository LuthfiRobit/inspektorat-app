...
@section('title', 'Edit Petugas Desa | Sistem Pelaporan')
@section('meta-description', 'Halaman untuk mengubah data petugas Desa.')
                    ...
                    <div class="card">
                        ...
                        <div class="card-header-compact border-0">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    <h5 class="mb-1 fw-bold" style="font-size: 1rem;">Edit Data Petugas</h5>
                                    <span class="text-muted small">Perbarui informasi petugas sesuai data terbaru.</span>
                                </div>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <ul class="mb-0 mt-1">
                                            ...
                                            <li>NIP digunakan sebagai <strong>username</strong> petugas dan <strong>tidak
                                                    dapat diubah</strong>.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

                            <form id="editForm" method="post" enctype="multipart/form-data" data-id="">
                                @csrf
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <label for="edit_nip" class="form-label-sm">
                                                Nomor Induk Pegawai (NIP)
                                            </label>
                                            <input type="text" class="form-control form-control-sm" id="edit_nip" name="nip"
                                                placeholder="Masukkan NIP" maxlength="20" autocomplete="off" readonly />
                                            <small class="form-text-helper">
                                                *NIP digunakan sebagai username petugas dan tidak dapat diubah.
                                            </small>
                                        </div>

                                        <div class="col-lg-6 col-md-6 col-12">
                                            <label for="edit_nama_lengkap" class="form-label-sm">
                                                Nama Lengkap <span class="text-danger">*</span>
                                            </label>
                                            <input type="text" class="form-control form-control-sm" id="edit_nama_lengkap"
                                                name="nama_lengkap" placeholder="Masukkan nama lengkap" maxlength="100"
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <label for="edit_kecamatan_id" class="form-label-sm">
                                                Kecamatan <span class="text-danger">*</span>
                                            </label>
                                            <select id="edit_kecamatan_id" name="kecamatan_id"
                                                class="selectpicker form-control wide form-select-sm"
                                                data-live-search="false" aria-label="Pilih kecamatan" required>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <label for="edit_desa_id" class="form-label-sm">
                                                Desa <span class="text-danger">*</span>
                                            </label>
                                            <select id="edit_desa_id" name="desa_id"
                                                class="selectpicker form-control wide form-select-sm"
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <label for="edit_jabatan" class="form-label-sm">
                                                Jabatan <span class="text-danger">*</span>
                                            </label>
                                            <select id="edit_jabatan" name="jabatan"
                                                class="selectpicker form-control wide form-select-sm"
                                                data-live-search="true" required aria-label="Pilih Jabatan" data-size="5">
                                                <option value="">-- Pilih Jabatan --</option>
                                                @foreach ($jabatanDesa as $item)
                                                    <option value="{{ $item->role_name }}">{{ $item->role_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <label for="edit_alamat" class="form-label-sm">
                                                Alamat Lengkap <span class="text-danger">*</span>
                                            </label>
                                            <textarea class="form-control form-control-sm" id="edit_alamat" name="alamat"
                                                rows="2" placeholder="Masukkan alamat lengkap" required></textarea>
                                        </div>

                                        <div class="col-lg-6 col-md-6 col-12">
                                            <label for="edit_no_telp" class="form-label-sm">
                                                Nomor Telepon <span class="text-danger">*</span>
                                            </label>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text"><i class="las la-phone"></i></span>
                                                <input type="text" class="form-control form-control-sm" id="edit_no_telp"
                                                    name="no_telp" placeholder="Masukkan nomor telepon" maxlength="20"
                                                    autocomplete="off" required />
                                            </div>
                                        </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <label for="edit_tanggal_awal" class="form-label-sm">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <label for="edit_tanggal_akhir" class="form-label-sm">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <label for="edit_status" class="form-label-sm">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            ...
                                            <small class="form-text-helper">
                                                <i class="las la-image"></i> Format: JPG, PNG. Maksimal 2MB. Kosongkan jika
                                                ...
                                                <div class="d-flex flex-wrap gap-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="akses_login"
                                                            id="edit_akses_login_active" value="active">
                                                        <label class="form-check-label" for="edit_akses_login_active">
                                                            <i class="las la-check-circle text-success"></i> Aktif
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="akses_login"
                                                            id="edit_akses_login_inactive" value="inactive">
                                                        <label class="form-check-label" for="edit_akses_login_inactive">
                                ...
                                <div class="d-flex justify-content-between gap-2 mt-3 pt-3 border-top">
                                    ...
                                    <button type="submit" form="editForm" class="btn btn-primary btn-action">
...
@section('this-page-scripts')
    @include('administration.masters.petugas.desa.scripts.edit-handler')
@endsection