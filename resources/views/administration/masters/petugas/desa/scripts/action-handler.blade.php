<script>
    ...
    $('#example').on('click', '.dropdown-item', function () {
        ...
        const url = '{{ route('administrator.master.petugas.desa.show', ':id') }}'.replace(':id',
            dataId);
    ...
    function handleEdit(data) {
        const editUrl = '{{ route('administrator.master.petugas.desa.edit', ':id') }}'.replace(':id', data
            .id_petugas);
        window.location.href = editUrl;
    }

    function handleResetPassword(data) {
        let routeTemplate = '{{ route('administrator.master.petugas.desa.reset-password', ':id') }}';
