<script>
    ...
    function handleEdit(data) {
        const editUrl = '{{ route('administrator.master.petugas.kecamatan.edit', ':id') }}'.replace(':id', data
            .id_petugas);
        window.location.href = editUrl;
    }

    function handleResetPassword(data) {
        let routeTemplate = '{{ route('administrator.master.petugas.kecamatan.reset-password', ':id') }}';
    ...
    function handleDelete(data) {
        let routeTemplate = '{{ route('administrator.master.petugas.kecamatan.destroy', ':id') }}';
        const url = routeTemplate.replace(':id', data.id_petugas);
