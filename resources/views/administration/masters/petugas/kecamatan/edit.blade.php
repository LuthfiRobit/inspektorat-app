...
@section('title', 'Edit Petugas Kecamatan | Sistem Pelaporan')
@section('meta-description', 'Halaman untuk mengubah data petugas Kecamatan.')
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm bg-light" id="edit_nip"
                                                name="nip" maxlength="20" placeholder="Masukkan NIP" readonly>
                                            <small class="form-text-helper">
                                                <i class="las la-lock"></i> NIP tidak dapat diubah
                                            </small>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="email" class="form-control form-control-sm" id="edit_email"
                                                    name="email" placeholder="Contoh: imron@kecamatan.local" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('this-page-scripts')
    @include('administration.masters.petugas.kecamatan.scripts.edit-handler')
@endsection
