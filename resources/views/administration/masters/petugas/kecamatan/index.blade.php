...
@section('title', 'Petugas Kecamatan | Sistem Pelaporan')
@section('meta-description', 'Halaman untuk mengelola data petugas Kecamatan dalam sistem pelaporan.')
...
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block border-0 pb-0 flex-wrap align-items-center">
                        <div class="me-auto mb-sm-0 mb-3">
                            ...
                            <span class="fs-12 text-muted">Kelola data petugas Kecamatan dengan mudah.</span>
                        </div>
                        ...
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            ...
                            @if (auth()->user()->hasPermissionTo('administrator.master.petugas.kecamatan.create'))
                                <a href="{{ route('administrator.master.petugas.kecamatan.create') }}"
    ...
    @include('administration.masters.petugas.kecamatan.components.detail')
@endsection
...
@section('this-page-scripts')
    ...
    @include('administration.masters.petugas.kecamatan.scripts.datatable-init')
    @include('administration.masters.petugas.kecamatan.scripts.action-handler')
@endsection