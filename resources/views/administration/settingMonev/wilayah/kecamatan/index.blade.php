...
@section('tab-content')
    ...
    <div class="d-sm-flex d-block border-bottom pb-3 mb-3 flex-wrap align-items-center justify-content-between">
        <div class="mb-2 mb-sm-0">
            ...
            <span class="fs-12 text-muted">Kelola data kecamatan sesuai kebutuhan monev.</span>
        </div>
        <div class="d-flex align-items-center gap-2">
            ...
            <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modalCreateKecamatan">
    ...
    <div class="row mb-3 gy-2">
        ...
        <div class="col-12 col-md-auto d-flex flex-wrap gap-2 justify-content-md-end">
            <button class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#modalImportKecamatan">
        ...
        <table id="example" class="table table-sm align-middle table-striped gs-0 gy-2 nowrap" style="width:100%;">
            <thead>
                <tr class="text-center text-muted text-uppercase">
                    ...
                    <th style="width: 25%;" class="text-start">Kode Kecamatan</th>
                    <th style="width: 40%;" class="text-start">Nama Kecamatan</th>
    ...
    <div class="alert alert-primary mt-3">
        <strong>Catatan:</strong> Data kecamatan menjadi acuan utama bagi desa.
    </div>

    <!-- Modal Create Kecamatan -->
    @include('administration.settingMonev.wilayah.kecamatan.components.create')
@endsection
