            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-12 mb-2">
                        <div class="row">
                            <div class="col-6"><span class="fs-6 fw-bold">Scope Role</span></div>
                            <div class="col-6"><span class="fs-6 fw-bold">:</span> <span id="detail_role_scope"
                                    class="mb-0"></span></div>
                        </div>
                    </div>
                    <div class="col-12 mb-2">
                    ...
                    <div class="col-12 mb-2">
                        <div class="row">
                            ...
                            <div class="col-6"><span class="fs-6 fw-bold">:</span> <span id="detail_role_description"
                                    class="mb-0"></span></div>
                        </div>
                    </div>
                </div>
