...
@section('content')
    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            ...
            <div class="form-head mb-4 d-flex align-items-center gap-2">
                ...
                <h4 class="text-dark fw-semibold mb-0">Permission Management</h4>
            </div>
    ...
    @include('administration.rbac.permission.components.create')
    @include('administration.rbac.permission.components.detail')
    @include('administration.rbac.permission.components.edit')
@endsection
...
@section('this-page-scripts')
    ...
    @include('administration.rbac.permission.scripts.sync-handler')
    @include('administration.rbac.permission.scripts.datatable-init')
    @include('administration.rbac.permission.scripts.action-handler')
    @include('administration.rbac.permission.scripts.modal-create-handler')
    @include('administration.rbac.permission.scripts.modal-edit-handler')
@endsection
